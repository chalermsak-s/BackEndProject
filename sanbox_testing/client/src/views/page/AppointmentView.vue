  ...
  <div class="appointment-container">
    <div class="appointment-header">
      ...
      <div class="appointment-actions">
        <button class="btn-primary" @click="createAppointment">Schedule Appointment</button>
        ...
        <div class="appointments-header">
          ...
          <div class="filters">
            <select v-model="selectedType" class="filter-select">
              ...
              <option v-for="type in Object.values(AppointmentType)" :key="type" :value="type">
                {{ type }}
              </option>
            </select>
            <select v-model="selectedStatus" class="filter-select">
              <option value="">All Statuses</option>
              <option v-for="status in Object.values(AppointmentStatus)" :key="status" :value="status">
                {{ status }}
              </option>
            </select>
          </div>
          ...
          <div v-for="appointment in filteredAppointments" :key="appointment.id" 
            ...
            <div class="appointment-meta">
              ...
              <div class="meta-item">
                ...
                <span class="meta-value">{{ formatParticipants(appointment.participants) }}</span>
              </div>
            </div>
            <div class="appointment-actions">
              <button class="btn-edit" @click="editAppointment(appointment)">Edit</button>
              <button class="btn-delete" @click="deleteAppointment(appointment)">Cancel</button>
            </div>
          </div>
        </div>
      </div>
...
import type { Appointment, AppointmentStats, AppointmentType, AppointmentStatus } from '@/types/appointment'
